    ...
    <>
      ...
      <div id="Footer" className="w-full  pb-20 h-3/4 xs:h-full xs:mb-20">
        <div className="md:flex-row sm:flex-col ss:flex-col xs:flex-col flex items-center justify-around px-14">
          <div className="xs:flex xs:flex-col ml-20 xs:justify-center xs:items-center">
            <div className="flex-auto">
              ...
              >
                <img className="w-44 bg-blend-color bg-no-repeat" src={Logo} alt="" />
              </a>
            </div>
            <h2 className="dark:text-gray-300 ml-6 font-poppins mt-1 xs:text-[18px] text-[20px] font-medium">
              Rent it now!
            </h2>
        ...
        <div className="flex flex-row  xs:flex-col ss:ml-0 ss:px-4 xs:px-8 xs:py-3 justify-around items-center ml-4 py-6">
          ...
          <div className="flex flex-col dark:text-white">
            ...
            <ul>
              ...
              <li className="dark:text-white">
                <AttachEmailOutlinedIcon className="text-yellow-400" /> airyyrides@gmail.com
              </li>
              <li className="dark:text-white">
                <PlaceOutlinedIcon className="text-yellow-400" /> 160/4, Bholaram Ustad Marg, Indrapuri Colony, Bhanwar Kuwa,
          ...
          <div className="dark:text-white xs:hidden ss:hidden">
            ...
            <ul>
              <li className="hover:underline cursor-pointer xs:text-[13px]">FAQ</li>
              <li className="hover:underline cursor-pointer xs:text-[13px]">Terms and Conditions</li>
              <li className="hover:underline pb-2 cursor-pointer xs:text-[13px]">Fee Policy</li>
            </ul>
          </div>
        ...
        <div className="flex flex-col sm:hidden">
          <div className="dark:text-white flex flex-col w-screen ml-[6.8rem] mt-10 justify-start">
            ...
            <ul>
              <li className="hover:underline cursor-pointer xs:text-[13px]">FAQ</li>
              <li className="hover:underline cursor-pointer xs:text-[13px]">Terms and Conditions</li>
              <li className="hover:underline cursor-pointer xs:text-[13px]">Fee Policy</li>
            </ul>
            {/* Social Links for smaller screens */}
            <div className="flex sm:hidden dark:text-white flex-row gap-4 h-[5rem] py-10">
              <CiFacebook size={26} />
          ...
          <div>
            <Zoom bottom>
              <img
                src={FooterImg}
                alt="Footer Img"
                className="rounded-2xl sm:hidden mr-10 "
                height={400}
                width={830}
              />
            </Zoom>
      ...
      <div className="w-screen snap-start justify-between flex  px-44 text-white">
