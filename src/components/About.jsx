...
const About = () => {
  return (
    <div
      id="NewRootRoot"
      className="flex flex-row w-full  snap-center  items-start"
    >
      <div
        id="About"
        className="overflow-hidden bg-black     relative flex flex-row w-full font-poppins items-start pt-[213px] px-[209px]"
      >
        <div
          id="Ellipse"
